 ...
 */
public class ProcessLogfileLinesPipelineTest {

    private final static Logger LOGGER = LoggerFactory.getLogger(ProcessLogfileLinesPipelineTest.class);

    private String lines[] = new String[3];
    private ProcessLogfileLinesEvent events[] = new ProcessLogfileLinesEvent[3];
    private ProcessLogfileLinesPipeline processLogfileLinesPipeline = new ProcessLogfileLinesPipeline();
    ...
    public void setup(){
        ...
        for(int i=0;i<3;i++){
            ...
            ll.setLine(lines[i]);
            events[i] = new ProcessLogfileLinesEvent();
            events[i].setLine(ll);
        }
    }
    ...
    public void getTimeStampTest(){
        for(int i=0;i<3;i++){
            ProcessLogfileLinesEvent result = processLogfileLinesPipeline.getTimeStamp(events[i]);
    ...
    public void getRequestStringTest(){
        for(int i=0;i<3;i++){
            ProcessLogfileLinesEvent result = processLogfileLinesPipeline.getRequestString(events[i]);
            LOGGER.info(result.toString());
    ...
    public void getHttpCodeTest(){
        for(int i=0;i<3;i++){
            ProcessLogfileLinesEvent result = processLogfileLinesPipeline.getHttpCode(events[i]);
            LOGGER.info(result.toString());
    ...
    public void getBrowserTest(){
        for(int i=0;i<3;i++){
            ProcessLogfileLinesEvent result = processLogfileLinesPipeline.getBrowser(events[i]);
            LOGGER.info(result.toString());
